...
for pers in socio:
    ...
    print(socio[pers]['filenames']+' '+str(len(socio[pers]['files'])))
# for f in socio:
...
for f in socio:
    ...
    people.append({'nome':socio[f]['nome'],'cognome':socio[f]['cognome']})
...
for ind in range(fre_mat.shape[1]):
    ...
    #print("%s %f" % (terms[ind],fre[terms[ind]]))     
gen_cloud_fre('cloud.png',fre,"logo ai s.ombra 978x532 grey.png")
